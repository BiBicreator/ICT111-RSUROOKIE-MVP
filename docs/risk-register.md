...
|---|---|---|---|---|---|---|---|---|---|
| R-01 | Privacy | Users may upload building images that accidentally include people or personal information. | FR-15 | Medium | Low | Display a privacy notices and instruct users to upload only building images without personal information. | Member 1 | Issue #6 | Open |
...
| R-05 | Legal | Campus photos or maps may be used without appropriate permissions. | FR-15 | Medium | Low | Use only team-created photos or resources with permission for educational purposes. | Member 1 | Issue #4 | Open |
