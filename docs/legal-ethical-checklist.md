...
| The prototype does not collect unnecessary sensitive data. | Yes | The prototype only accepts uploaded building images and does not collect personal information such as student ID, phone number, or email. | Continue limiting data collection to information required for the prototype. | Member 1 | Issue #2 |
...
- Add clearer guidance when uploaded images are blurry or cannot be recognized.
